        ...
        <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="添加" />
         <table>
		  ...
		  <tr>
		    ...
		    $SearchHtml$
		    录入时间：从
      <asp:TextBox ID="txtT1" runat="server" onclick="WdatePicker()" Width="75px"></asp:TextBox>
      到
      <asp:TextBox ID="txtT2" runat="server" onclick="WdatePicker()" Width="75px"></asp:TextBox>
