...
public partial class _$FileName$ : System.Web.UI.Page
{
    ...
    protected void OptEdit(string id)
    {
        ...
        txtFromUrl.Value = Request.UrlReferrer.ToString();
    }
    ...
    {
        Response.Redirect(Request.Path.ToString() + "?act=Add",true);
    }

    protected void btnSearch_Click(object sender, EventArgs e)
    {
        Response.Redirect(Request.Path 
        	+ "?txtTitle=" //+ Server.HtmlEncode(txtTitle.Text)
			+ "&txtT1=" + Server.HtmlEncode(Request.Form["txtT1"])
			+ "&txtT2=" + Server.HtmlEncode(Request.Form["txtT2"])
//$SearchCodeURL$
